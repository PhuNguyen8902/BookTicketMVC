            ...
            <tbody>
                <c:forEach items="${customer}" var="p">
                    <tr>
                        ...
                        <td>${p.phone}</td>
                        <td>
                            <a href="/backend/admin/customer/${p.id}" class="btn btn-success">Update</a>
                            <button class="btn btn-danger" onclick="deleteUser('/backend/admin/customer/delete/${p.id}', null)">Delete</button>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
