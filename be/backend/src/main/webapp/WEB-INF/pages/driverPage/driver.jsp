            ...
            <tbody>
                <c:forEach items="${driver}" var="p">
                    <tr>
                        ...
                        <td>${p.phone}</td>
                        <td>
                            <a href="/backend/admin/driver/${p.id}" class="btn btn-success">Update</a>
                            <button class="btn btn-danger" onclick="deleteUser('/backend/admin/driver/delete/${p.id}', null)">Delete</button>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
