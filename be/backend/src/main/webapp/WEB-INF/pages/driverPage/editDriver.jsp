...
<c:url value="/admin/driver" var="action" />

<h1 class="text-center text-info mt-1">Driver Detail</h1>

<form:form modelAttribute="driver" method="post" action="${action}" enctype="multipart/form-data">
