            ...
            <tbody>
                <c:forEach items="${employee}" var="p">
                    <tr>
                        ...
                        <td>${p.phone}</td>
                        <td>
                            <a href="/backend/admin/employee/${p.id}" class="btn btn-success">Update</a>
                            <button class="btn btn-danger" onclick="deleteUser('/backend/admin/employee/delete/${p.id}', null)">Delete</button>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
