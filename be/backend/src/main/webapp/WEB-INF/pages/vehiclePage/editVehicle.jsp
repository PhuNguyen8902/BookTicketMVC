...
<c:url value="/admin/vehicle" var="action" />
<h1 class="text-center text-info mt-1">Vehicle Detail</h1>

<form:form modelAttribute="vehicle" method="post" action="${action}" enctype="multipart/form-data">
